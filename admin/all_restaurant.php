...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
         ...
         <div class="header">
            ...
            <div class="navbar-header">
                    <a class="navbar-brand" href="dashboard.php">
                        ...
                        <span><img src="images/icn2.png" alt="homepage" class="dark-logo" /></span>
                    </a>
                </div>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                   <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-car f-s-20 color-warning"></i><span class="hide-menu">Packages</span></a>
                            <ul aria-expanded="false" class="collapse">
								<li><a href="all_restaurant.php">All Suppliers</a></li>
								<li><a href="add_category.php">Add Category</a></li>
                                <li><a href="add_restaurant.php">Add Supplier</a></li>
                                
                            </ul>
                        </li>
                      <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-archive" aria-hidden="true"></i><span class="hide-menu">Packages</span></a>
                            <ul aria-expanded="false" class="collapse">
        ...
        <div class="page-wrapper">
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">All Suppliers</h4>
                            </div>
                                        ...
                                        <tbody>
												...
												$query=mysqli_query($db,$sql);
													...
													if(!mysqli_num_rows($query) > 0 )
														{
															echo '<td colspan="11"><center>No Suppliers</center></td>';
														}
													else
														{				
            ...
            <footer class="footer"> © 2024 - Water Ordering System </footer>
